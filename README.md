...
2. **Native Libraries & TDLib Wrapper (CRITICAL)**:
   ...
   - **MANDATORY**: You MUST replace `app/src/main/java/org/drinkless/tdlib/TdApi.java` with the full, autogenerated version from your TDLib build. The provided version in this repo is a structural placeholder only and lacks the correct CONSTRUCT_IDs required for JNI linkage.

...
2. **Native Libraries & TDLib Wrapper (CRITICAL)**:
   ...
   - **Official API**: This project includes the official TDLib 1.8.x Java API bindings (`TdApi.java`, `Client.java`, `Log.java`). These files are configured with the correct JNI constructor IDs to work directly with standard native binaries.

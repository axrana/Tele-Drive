...
2. **Native Libraries & TDLib Wrapper (CRITICAL)**:
   ...
   - **API Replacement**: This project includes a JNI-compatible `TdApi.java` bridge that matches TDLib 1.8.x semantics. For production use or when updating TDLib, it is highly recommended to use the `TdApi.java` autogenerated by your specific TDLib build process to ensure 100% binary compatibility.
